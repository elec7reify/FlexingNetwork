...
import com.flexingstudios.FlexingNetwork.impl.player.FCoinsMenu;
...
public class GroupsMenu implements InvMenu {
    ...
    public GroupsMenu(Player player) {
        ...
        this.inv.setItem(29, Items.name(premium, "&fПривилегия &5&lПремиумбамбони &f- &a&l49 Руб.&f/мес.",
                ...
                "&5• &fПример сообщения в чате:", "&7«&5&lПремиумбамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!",
                "", "&5◆ &fВозможность получить набор &5&lPREMIUM: &5/kit premium", "&5◆ &fВозможность одеть блок или предмет на голову: &5/hat",
                "&5◆ &fВозможность установить &5&l6 &fточек дома: &5/sethome", "&5◆ &fВозможность восстановить голод: &5/feed",
                "&5◆ &fВозможность очистить себе инвентарь: &5/ci", "&5◆ &fВозможность включить режим бессмертия: &5/god", "&5> &fВозможность отключить телепорт к себе: &5/tptoggle", "&5◆ &fВозможность показать ближайших игроков: &5/near",
                "", "&c▪ Донат выдается на &c&lвсе &cсервера.", "&6▪ Возможности &6&lпредыдущих &6донатов.",
                "&a▪ Донат &a&lостается &aпосле вайпа.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
        ...
        this.inv.setItem(30, Items.name(creative, "&fПривилегия &9&lЧикикреатив &f- &a&l69 Руб.&f/мес.", "",
                "&9• &fПрефикс в чат и таб: &7«&9&lЧикикреатив&7» &7" + player.getDisplayName(), "&9• &fПример сообщения в чате:",
                "&7«&9&lЧикикреатив&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                "&9◆ &fВозможность запросить телепорт к себе: &9/tpahere", "&9◆ &fВозможность установить &9&l12 &fточек дома: &9/sethome",
                "&9◆ &fВозможность установить творческий режим: &9/gamemode 1", "&9◆ &fВозможность телепорт по координатам: &9/tppos",
                "&9◆ &fВозможность узнать координаты: &9/getpos", "&9◆ &fВозможность узнать настоящее имя игрока: &9/realname",
                "&9◆ &fВозможность изменить для себя время: &9/ptime", "&9◆ &fВозможность изменить для себя погоду: &9/pweather", "",
                "&c▪ Донат выдается на &c&lвсе &cсервера.", "&6▪ Возможности &6&lпредыдущих &6донатов.", "&a▪ Донат &a&lостается &aпосле вайпа.",
        ...
        this.inv.setItem(37, Items.name(moder, "&fПривилегия &e&lЧикимодератор &f- &a&l99 Руб.",
                "&e• &fПрефикс в чат и таб: &7«&e&lЧикимодератор&7» &7" + player.getDisplayName(), "&e• &fПример сообщения в чате: ",
                "&7«&e&lЧикимодератор&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "", "&e◆ &fВозможность выдать себе опыт: &e/exp",
                "&e◆ &fВозможность установить &e&l15 &fточек дома: &e/sethome", "&e◆ &fВозможность восстановить здоровье: &e/heal",
                "&e◆ &fВозможность перейти в AFK: &e/afk", "&e◆ &fВозможность редактировать книги: &e/book", "&e◆ &fВозможность проверить баланс игрока: &e/bal &7[ник]",
                "e◆ &fВозможность потушить себя: &e/ext", "", "&c▪ Донат выдается на &c&lвсе &cсервера.", "&6▪ Возможности &6&lпредыдущих &6донатов.",
                "&a▪ Донат &a&lостается &aпосле вайпа.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
        ...
        this.inv.setItem(38, Items.name(chikibamboni, "&fПривилегия &3&lЧикибамбони &f- &a&l129 Руб.",
                "&3• &fПрефикс в чат и таб: &7«&3&lЧикибамбони&7» &7" + player.getDisplayName(), "&3• &fПример сообщения в чате:", "",
                "&7«&3&lЧикибамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "", "&3◆ &fВозможность тп к игрокам: &3/tp",
                "&3◆ &fВозможность установить &3&l20&f точек дома: &3/sethome", "&3◆ &fВозможность установить режим наблюдателя: &3/gamemode 3",
                "&3◆ &fВозможность установить режим приключений: &3/gamemode 2", "&3◆ &fВозможность переключить режим игры игрокам: &3/gamemode 0-3 &7[ник]", "",
                "&3◆ &fВозможность включить невидимость: &3/v", "&3◆ &fВозможность телепорт наверх: &3/top", "", "&c▪ Донат выдается на &c&lвсе &cсервера.",
        ...
        this.inv.setItem(39, Items.name(admin, "&fПривилегия &b&lАдминобамбони &f- &a&l179 Руб.",
                "&b• &fПрефикс в чат и таб: &7«&b&lАдминобамбони&7» &7" + player.getDisplayName(), "&b• &fПример сообщения в чате:", "",
                "&7«&b&lАдминобамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "", "&b◆ &fВозможность изменить ник: &b/nick [новый ник]", "", "&c▪ Донат выдается на &c&lвсе &cсервера.",
                "&6▪ Возможности &6&lпредыдущих &6донатов.", "&a▪ Донат &a&lостается &aпосле вайпа.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
        ...
        this.inv.setItem(32, Items.name(chikybambonylla, "&fПривилегия &2&lЧикибамбонила &f- &a&l219 Руб.",
                "&2• &fПрефикс в чат и таб: &7«&2&lЧикибамбонила&7» &7" + player.getDisplayName(), "&2• &fПример сообщения в чате:", "",
                "&7«&2&lЧикибамбонила&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "", "&c▪ Донат выдается на &c&lвсе &cсервера.",
                "&6▪ Возможности &6&lпредыдущих &6донатов.", "&a▪ Донат &a&lостается &aпосле вайпа.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
        ...
        this.inv.setItem(41, Items.name(bombaster, "&fПривилегия &c&lЧикибомбастер &f- &a&l699 Руб.",
                "&c• &fПрефикс в чат и таб: &7«&c&lЧикибомбастер&7» &f" + player.getDisplayName(), "&c• &fПример сообщения в чате:", "",
                "&7«&c&lЧикибомбастер&7» &f" + player.getDisplayName() + " &8→ &7Hello World!", "", "&6• &fВключен &6&n&lиммунитет&f от бана/кика/мута &7(Но админ сервера сможет забанить)", "", "&c▪ Донат выдается на &c&lвсе &cсервера.",
                "&6▪ Возможности &6&lпредыдущих &6донатов.", "&a▪ Донат &a&lостается &aпосле вайпа.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
        ...
        this.inv.setItem(42, Items.name(god, "&fПривилегия &4&lЧикибамбог &f- &a&l2499 Руб.",
                "&4• &fПрефикс в чат и таб: &7«&4&lЧикибамбог&7» &f" + player.getDisplayName(), "&4• &fПример сообщения в чате:", "",
                "&7«&4&lЧикибамбог&7» &f" + player.getDisplayName() + " &8→ &7Hello World!", "", "&c&lвоистину королевская привилегия для олигархичей",
                "&c&lЛучшее решение на сервере, которое вы можете себе позволить", "", "&4◆ &fДоступ к вершине этого сервера",
                "&4◆ &fВыше тебя будет только Администрация", "&4◆ &c&lЛучший донат для тех, кто хочет вписать своё имя в историю сервера",
                "&4◆ &4&lСтань ебучей легендой Найт-сити!", "", "&6• &fВключен &6&n&lиммунитет&f от бана/кика/мута &7(Но админ сервера сможет забанить)", "",
                "&c▪ Донат выдается на &c&lвсе &cсервера.", "&6▪ Возможности &6&lпредыдущих &6донатов.", "&a▪ Донат &a&lостается &aпосле вайпа.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
    ...
    private static class MiniGamesGroups implements InvMenu {
        ...
        public MiniGamesGroups(Player player) {
            ...
            this.inv.setItem(28, Items.name(vip, "&fПривилегия &a&lЧикибамбвипка &f- &a&l29 Руб.&f/мес.", "",
                    "&c&lУ данной привилегии прав на мини-играх нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n60&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            this.inv.setItem(29, Items.name(premium, "&fПривилегия &5&lПремиумбамбони &f- &a&l49 Руб.&f/мес.", "",
                    "&c&lУ данной привилегии прав на мини-играх нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n100&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            this.inv.setItem(30, Items.name(creative, "&fПривилегия &9&lЧикикреатив &f- &a&l69 Руб.&f/мес.", "",
                    "&c&lУ данной привилегии прав на мини-играх нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n130&9&l Flex&f&lCoin &fза покупку",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            this.inv.setItem(37, Items.name(moder, "&fПривилегия &e&lЧикимодератор &f- &a&l99 Руб.", "",
                    ...
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n200&9&l Flex&f&lCoin &fза покупку",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            this.inv.setItem(38, Items.name(chikibamboni, "&fПривилегия &3&lЧикибамбони &f- &a&l129 Руб.", "",
                    "&c&lУ данной привилегии прав на мини-играх нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n250&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус admin (Админобамбони)
            ItemStack admin = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/3e427adff356f0945ebba391ca0eef465ae17461ea7c53ad173fbb6c7f36a8", 1)).build();
            this.inv.setItem(39, Items.name(admin, "&fПривилегия &b&lАдминобамбони &f- &a&l179 Руб.", "",
                    " &b◆ &fВозможность изменить ник: &b/nick [новый ник]", " &b◆ &fВозможность узнать настоящий ник игрока: &b/realname [ник игрока]", "",
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n360&9&l Flex&f&lCoin &fза покупку",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус chikybambonylla (Чикибамбонила)
            ItemStack chikybambonylla = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/58b3ffd37e6f32a4e7c1aba2cb484923cf695f447c879e712ec25a613e010", 1)).build();
            this.inv.setItem(32, Items.name(chikybambonylla, "&fПривилегия &2&lЧикибамбонила &f- &a&l219 Руб.", "",
                    " &2◆ &fВозможность кикнуть недоброжелателя: &2/kick [ник игрока]", " &2◆ &fВозможность писать цветным текстом в чате", " &2• &fПример сообщения в чате:",
                    " &7«&2&lЧикибамбонила&7» &7" + player.getDisplayName() + " &8→ &3Fisting &5ass", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n450&9&l Flex&f&lCoin &fза покупку",
                    "", " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить",
                    " &c&lнаказание. Вы несёте ответственность за свои действия.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус sponsor (Спонсорбамбони)
            ItemStack sponsor = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/c1df70dc9885e418b58d8e7486a81ed4ec2e7963c42569c468084d4f567c6", 1)).build();
            this.inv.setItem(33, Items.name(sponsor, "&fПривилегия &d&lСпонсорбамбони &f- &a&l299 Руб.", "",
                    " &d◆ &fВозможность забанить самых настырных: &d/ban 30min", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n600&9&l Flex&f&lCoin &fза покупку",
                    "", " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить", " &c&lнаказание. Вы несёте ответственность за свои действия.",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус owner (Чикивладелец)
            ItemStack owner = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/6c92e3f45b49e405670224892f93ebc84fa7f8c96c36aab24a8854f2cbf0b8", 1)).build();
            this.inv.setItem(34, Items.name(owner, "&fПривилегия &6&lЧикивладелец &f- &a&l449 Руб.", "",
                    " &6• &fВключен &6&n&lиммунитет&f от бана/кика/мута &7(Но админ сервака сможет забанить)", "", " &6◆ &fУвеличено допустимое время для бана игрока: &6/ban 2h", "",
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n900&9&l Flex&f&lCoin &fза покупку", "",
                    " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить", " &c&lнаказание. Вы несёте ответственность за свои действия.",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            ItemStack bombaster = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/b88fb6b2b3efa6ab299f9f4e7d8c1a1d7338753bdf8fef81075f2155943bc69", 1)).build();
            this.inv.setItem(41, Items.name(bombaster, "&fПривилегия &c&lЧикибомбастер &f- &a&l699 Руб.", "",
                    " &c• &fВключен &c&n&lиммунитет&f от бана/кика/мута &7(Но админ сервака сможет забанить)", "", " &c◆ &fУвеличено допустимое время для бана игрока: &6/ban 1week", "",
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.",
                    " &f▪ Вы получите &b&l&n1500&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус god (Чикибамбог)
            ItemStack god = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/b88fb6b2b3efa6ab299f9f4e7d8c1a1d7338753bdf8fef81075f2155943bc69", 1)).build();
            this.inv.setItem(42, Items.name(god, "&fПривилегия &4&lЧикибамбог &f- &a&l2499 Руб.", "",
                    "&c&lвоистину королевская привилегия для олигархичей", "&c&lЛучшее решение на сервере, которое вы можете себе позволить", " &4• &fВключен &4&n&lиммунитет&f от бана/кика/мута &7(Но админ сервака сможет забанить)",
                    "", " &4◆ &4&n&lЭКСКЛЮЗИВ:&f доступ к Бану по IP на 30 минут", " &4◆ &4&n&lЭКСКЛЮЗИВ:&f доступ к Муту на 10 часов", "",
                    " &4◆ &fДоступ к вершине этого сервера", " &4◆ &fВыше тебя будут только админы", " &4◆ &c&lЛучший донат для тех, кто хочет вписать своё имя в историю сервера",
                    " &4◆ &4&lСтань ебучей легендой Найт-сити!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.",
                    " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n5000&9&l Flex&f&lCoin &fза покупку",
                    " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить", " &c&lнаказание. Вы несёте ответственность за свои действия.", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
    ...
    private static class AnarchyMenu implements InvMenu {
        ...
        public AnarchyMenu(Player player) {
            ...
            this.inv.setItem(28, Items.name(vip, "&fПривилегия &a&lЧикибамбвипка &f- &a&l29 Руб.&f/мес.", "",
                    " &a• &fПрефикс в чат и таб: &7«&a&lЧикибамбвипка&7» &7" + player.getDisplayName(), " &a• &fПример сообщения в чате:",
                    "&7«&a&lЧикибамбвипка&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    "&c&lУ данной привилегии прав на анархии нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n60&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус premium (Премиумбамбони)
            ItemStack premium = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/595aca72dcce1298475398fb7adff8447c9a670e6cf64dd3933bbc94918e99", 1)).build();
            this.inv.setItem(29, Items.name(premium, "&fПривилегия &5&lПремиумбамбони &f- &a&l49 Руб.&f/мес.", "",
                    " &5• &fПрефикс в чат и таб: &7«&5&lПремиумбамбони&7» &7" + player.getDisplayName(), " &5• &fПример сообщения в чате:", "&7«&5&lПремиумбамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    "&c&lУ данной привилегии прав на анархии нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n100&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            ItemStack creative = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/595aca72dcce1298475398fb7adff8447c9a670e6cf64dd3933bbc94918e99", 1)).build();
            this.inv.setItem(30, Items.name(creative, "&fПривилегия &9&lЧикикреатив &f- &a&l69 Руб.&f/мес.", "",
                    " &9• &fПрефикс в чат и таб: &7«&9&lЧикикреатив&7» &7" + player.getDisplayName(), " &9• &fПример сообщения в чате:", "&7«&9&lЧикикреатив&7» &7" + player.getDisplayName() + " &8→ &7Hello World!",
                    "&c&lУ данной привилегии прав на анархии нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n130&9&l Flex&f&lCoin &fза покупку",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            ItemStack moder = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/595aca72dcce1298475398fb7adff8447c9a670e6cf64dd3933bbc94918e99", 1)).build();
            this.inv.setItem(37, Items.name(moder, "&fПривилегия &e&lЧикимодератор &f- &a&l99 Руб.", "",
                    " &e• &fПрефикс в чат и таб: &7«&e&lЧикимодератор&7»  &7" + player.getDisplayName(), " &e• &fПример сообщения в чате:", "&7«&e&lЧикимодератор&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
            ...
            ItemStack chikibamboni = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/595aca72dcce1298475398fb7adff8447c9a670e6cf64dd3933bbc94918e99", 1)).build();
            this.inv.setItem(38, Items.name(chikibamboni, "&fПривилегия &3&lЧикибамбони &f- &a&l129 Руб.", "",
                    " &3• &fПрефикс в чат и таб: &7«&3&lЧикибамбони&7» &7" + player.getDisplayName(), " &3• &fПример сообщения в чате:", "&7«&3&lЧикибамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    "&c&lУ данной привилегии прав на анархии нет!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n250&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            ItemStack admin = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/3e427adff356f0945ebba391ca0eef465ae17461ea7c53ad173fbb6c7f36a8", 1)).build();
            this.inv.setItem(39, Items.name(admin, "&fПривилегия &b&lАдминобамбони &f- &a&l179 Руб.", "",
                    " &b• &fПрефикс в чат и таб: &7«&b&lАдминобамбони&7» &7" + player.getDisplayName(), " &b• &fПример сообщения в чате:", "&7«&b&lАдминобамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    " &b◆ &fВозможность изменить ник: &b/nick [новый ник]", " &b◆ &fВозможность узнать настоящий ник игрока: &b/realname [ник игрока]", "",
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n360&9&l Flex&f&lCoin &fза покупку",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            ItemStack chikybambonylla = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/58b3ffd37e6f32a4e7c1aba2cb484923cf695f447c879e712ec25a613e010", 1)).build();
            this.inv.setItem(32, Items.name(chikybambonylla, "&fПривилегия &2&lЧикибамбонила &f- &a&l219 Руб.", "",
                    " &2• &fПрефикс в чат и таб: &7«&2&lЧикибамбонила&7» &7" + player.getDisplayName(), " &2• &fПример сообщения в чате:", "&2«&2&lЧикибамбонила&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    " &2◆ &fВозможность кикнуть недоброжелателя: &2/kick [ник игрока]", " &2◆ &fВозможность писать цветным текстом в чате", " &2• &fПример сообщения в чате:",
                    " &7«&2&lЧикибамбонила&7» &7" + player.getDisplayName() + " &8→ &3Fisting &5ass", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n450&9&l Flex&f&lCoin &fза покупку",
                    "", " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить",
            ...
            ItemStack sponsor = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/c1df70dc9885e418b58d8e7486a81ed4ec2e7963c42569c468084d4f567c6", 1)).build();
            this.inv.setItem(33, Items.name(sponsor, "&fПривилегия &d&lСпонсорбамбони &f- &a&l299 Руб.", "",
                    " &d• &fПрефикс в чат и таб: &7«&d&lСпонсорбамбони&7» &7" + player.getDisplayName(), " &d• &fПример сообщения в чате:", "&7«&d&lСпонсорбамбони&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    " &d◆ &fВозможность забанить самых настырных: &d/ban 30min", "", " &c▪ Донат выдается на &c&lвсе &cсервера.",
                    " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n600&9&l Flex&f&lCoin &fза покупку",
                    "", " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить", " &c&lнаказание. Вы несёте ответственность за свои действия.",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            ItemStack owner = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/6c92e3f45b49e405670224892f93ebc84fa7f8c96c36aab24a8854f2cbf0b8", 1)).build();
            this.inv.setItem(34, Items.name(owner, "&fПривилегия &6&lЧикивладелец &f- &a&l449 Руб.", "",
                    " &d• &fПрефикс в чат и таб: &7«&6&lЧикивладелец&7» &7" + player.getDisplayName(), " &d• &fПример сообщения в чате:", "&7«&6&lЧикивладелец&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    " &6• &fВключен &6&n&lиммунитет&f от бана/кика/мута &7(Но админ сервака сможет забанить)", "", " &6◆ &fУвеличено допустимое время для бана игрока: &6/ban 2h", "",
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.", " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n900&9&l Flex&f&lCoin &fза покупку", "",
                    " &c&lПримечание: в данной привилегии присутствуют права,", " &c&lЗа неправильное использование которых можно получить", " &c&lнаказание. Вы несёте ответственность за свои действия.",
                    "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));
            ...
            this.inv.setItem(41, Items.name(bombaster, "&fПривилегия &c&lЧикибомбастер &f- &a&l699 Руб.", "",
                    " &c• &fПрефикс в чат и таб: &7«&c&lЧикибомбастер&7» &f" + player.getDisplayName(), " &c• &fПример сообщения в чате:",
                    "&7«&c&lЧикибомбастер&7» &f" + player.getDisplayName() + " &8→ &7Hello World!", "", " &c• &fВключен &c&n&lиммунитет&f от бана/кика/мута &7(Но админ сервака сможет забанить)", " &c◆ &fУвеличено допустимое время для бана игрока: &6/ban 1week", "",
                    " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.",
                    " &a▪ Донат &a&lостается &aпосле вайпа.", " &f▪ Вы получите &b&l&n1500&9&l Flex&f&lCoin &fза покупку", "", "&fПокупать донат на сайте: &ewww.FlexingWorld.ru"));

            // Статус god (Чикибомбастер)
            ItemStack god = new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/b88fb6b2b3efa6ab299f9f4e7d8c1a1d7338753bdf8fef81075f2155943bc69", 1)).build();
            this.inv.setItem(42, Items.name(god, "&fПривилегия &4&lЧикибамбог &f- &a&l2499 Руб.", "",
                    " &d• &fПрефикс в чат и таб: &7«&4&lЧикибамбог&7» &7" + player.getDisplayName(), " &d• &fПример сообщения в чате:", "&7«&4&lЧикибамбог&7» &7" + player.getDisplayName() + " &8→ &7Hello World!", "",
                    "&c&lвоистину королевская привилегия для олигархичей", "&c&lЛучшее решение на сервере, которое вы можете себе позволить", " &4• &fВключен &4&n&lиммунитет&f от бана/кика/мута &7(Но админ сервака сможет забанить)",
                    "", " &4◆ &4&n&lЭКСКЛЮЗИВ:&f доступ к Бану по IP на 30 минут", " &4◆ &4&n&lЭКСКЛЮЗИВ:&f доступ к Муту на 10 часов", "",
                    " &4◆ &fДоступ к вершине этого сервера", " &4◆ &fВыше тебя будут только админы", " &4◆ &c&lЛучший донат для тех, кто хочет вписать своё имя в историю сервера",
                    " &4◆ &4&lСтань ебучей легендой Найт-сити!", "", " &c▪ Донат выдается на &c&lвсе &cсервера.", " &6▪ Возможности &6&lпредыдущих &6донатов.",
    ...
    private static class MoneyMenu implements InvMenu {
        ...
        public MoneyMenu(Player player) {
            ...
            this.inv.setItem(38, Items.name(new ItemBuilder(SkullBuilder.getSkull("https://textures.minecraft.net/texture/82cde068e99a4f98c31f87b4cc06be14b229aca4f7281a416c7e2f553223db74", 1)).build(), "&e&l№1. &fРазвитие сервера", "&fНа сервер тоже требуются деньги!", "&fОплата хоста, техническое обслуживание", "&fРазработка новых режимов - всё это требует денег"));
    ...
    private static class CautionMenu implements InvMenu {
        ...
        public CautionMenu(Player player) {
            ...
            this.inv.setItem(12, Items.name(Material.IRON_SWORD, "&f&lВозможности на &b&lМини-играх"));
            this.inv.setItem(14, Items.name(Material.QUARTZ, "&e&lКуда уйдут деньги с покупки?", "&7Прочитайте этот пункт", "&7Если вам интересно", "&7Что произойдёт с вашими деньгами"));
            this.inv.setItem(15, Items.name(Items.glow(Material.REDSTONE), "&c&lОбратите внимание", "&7Прочитайте этот пункт", "&7Если вам интересно", "&7Что произойдёт с вашими деньгами"));
            this.inv.setItem(16, Items.name(Material.MAGMA_CREAM, "&a&lВозможности админов", "&7Рекомендуется прочитать этот пункт", "&7Чтобы узнать больше об админах", "&7И их возможностях"));
