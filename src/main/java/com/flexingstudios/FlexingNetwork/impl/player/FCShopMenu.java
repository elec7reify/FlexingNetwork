...
public class FCShopMenu implements InvMenu {
    ...
    public FCShopMenu(Player player) {
        ...
        NetworkPlayer nplayer = FlexingNetwork.INSTANCE.getPlayer(player);
        ...
        GLASS_PANE_BLACK_META.setDisplayName(Utils.colored("&6&k|&a&k|&e&k|&c&k|"));
        ...
        GLASS_PANE_BLUE_META.setDisplayName(Utils.colored("&6&k|&a&k|&e&k|&c&k|"));
        ...
        GLASS_PANE_WHITE_META.setDisplayName(Utils.colored("&6&k|&a&k|&e&k|&c&k|"));
    ...
    public void onClick(ItemStack is, Player player, int slot, ClickType clicktype) {
        FlexPlayer flplayer = (FlexPlayer) FlexingNetwork.INSTANCE.getPlayer(player);
        switch (slot) {
            case 8:
