...
import com.flexingstudios.flexingnetwork.api.util.Attributes;
import gnu.trove.map.hash.TIntObjectHashMap;
import org.bukkit.Material;
import org.bukkit.inventory.ItemStack;

public enum ArrowTrail {
    HEARTS(1, "Сердца", new ItemStack(Material.INK_SACK, 1, (short) 1), 50, ItemRarity.COMMON),
    DRIP_WATER(2, "Капли воды", new ItemStack(Material.WATER_BUCKET), 40, ItemRarity.COMMON),
    DRIP_LAVA(3, "Капли лавы", new ItemStack(Material.LAVA_BUCKET), 40, ItemRarity.COMMON),
    FIREWORK(4, "Фейерверк", new ItemStack(Material.INK_SACK, 1, (short) 15), 150, ItemRarity.COMMON),
    NOTE(5, "Ноты", new ItemStack(Material.NOTE_BLOCK, 1), 50, ItemRarity.COMMON),
    SLIME(6, "Слизь", new ItemStack(Material.SLIME_BALL, 1), 70, ItemRarity.COMMON),
